...
class Individual(object):
    ...
    def create_gnome(self):
        ...
        '''
        pix = numpy.random.randint(100,100,3) * 255
        return pix
    ...
    def mate(self, par2):
        ...
        if k == 1:
            child_chromosome = \
                numpy.concatenate((self.chromosome[0:50], par2.chromosome[50:]))
        else:
            child_chromosome = \
                numpy.concatenate((par2.chromosome[50:], self.chromosome[0:50]))

        # numpy.concatenate((self.chromosome[0:int(length / 2)], par2.chromosome[int(length / 2):]))\
        # numpy.concatenate((par2.chromosome[int(length / 2):], self.chromosome[0:int(length / 2)]))\
        prob = random.random()
